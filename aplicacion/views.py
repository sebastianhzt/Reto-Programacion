...
#         # Validación básica según requerimiento (admin / 1234)
...
#     return render(request, 'gestion_torneo/login.html', {'error': error})
...
#     # Generar todos contra todos (Round Robin simple para 4 equipos)
